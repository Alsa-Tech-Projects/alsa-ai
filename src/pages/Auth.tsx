...
const Auth = () => {
  ...
  // Github login handler can be added similarly
  ...
  return (
    ...
    >
      <svg
        ...
        fill="currentColor"
      >
        <path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.207 11.387.6.113.793-.262.793-.582 0-.288-.01-1.05-.016-2.06-3.338.724-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.746.083-.73.083-.73 1.204.084 1.838 1.238 1.838 1.238 1.07 1.835 2.807 1.305 3.492.998.107-.775.42-1.305.762-1.605-2.665-.305-5.466-1.335-5.466-5.932 0-1.31.467-2.38 1.235-3.22-.124-.304-.536-1.527.117-3.182 0 0 1.008-.322 3.3 1.23a11.52 11.52 0 0 1 3-.405c1.02.005 2.04.138 3 .405 2.29-1.552 3.296-1.23 3.296-1.23.655 1.655.243 2.878.12 3.182.77.84 1.234 1.91 1.234 3.22 0 4.61-2.807 5.624-5.48 5.922.432.372.817 1.103.817 2.222 0 1.606-.014 2.898-.014 3.293 0 .322.19.7.8.582C20.565 21.796 24 17.3 24 12c0-6.63-5.37-12-12-12z" />
      </svg>
      <span className="font-bold text-base">Sign in with GitHub</span>
    </Button>
              </div>
            </div>
          </CardContent>

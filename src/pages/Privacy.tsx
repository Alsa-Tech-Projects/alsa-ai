...
Your data is stored securely on Supabase infrastructure with enterprise-grade security.`
    },
    {
      icon: Eye,
...
To exercise these rights, contact us at alsa.ai.assistant@gmail.com`
    },
    {
      icon: Bell,
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="mt-12 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-white/80">
              ...
              <li>🌐 Website: Contact form available on our Contact page</li>
            </ul>
          </div>
        </div>
      </div>

...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A1A2F] text-white overflow-x-hidden">
      <Helmet>
        <title>
          ALSA AI - Best AI Assistant for PC Automation, Voice Control & Coding
          | India
        </title>
        <meta
          name="description"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "ALSA AI",
            description:
              "AI-powered PC automation, voice control, and coding assistant",
            ...
            {authLoading ? (
              ...
              <>
                <Button
                  ...
                  className="text-white/70 hover:text-white text-xs px-2 md:px-4"
                >
                  Login
                </Button>
                ...
                <Button
                  size="sm"
                  onClick={() => navigate("/auth")}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-[10px] md:text-sm px-3 py-1"
                >
                  Get Started
                </Button>
              </>
      ...
      <section className="pt-28 md:pt-40 pb-20 px-4 text-center">
        <div className="container mx-auto">
          <Badge className="mb-6 bg-blue-600/10 text-blue-300 border-blue-500/20 px-4 py-1.5 text-[10px] md:text-sm">
            <Zap className="w-3 h-3 md:w-4 md:h-4 mr-2 inline" /> The First
            Agentic OS for Your PC & Android
          </Badge>
          ...
          <p className="text-base md:text-xl text-white/60 max-w-3xl mx-auto mb-10 leading-relaxed font-light px-4">
            Automate software development, control hardware, and manage data
            with an AI that doesn't just talk—it{" "}
            <span className="text-white font-medium">acts</span>.
          </p>
          {authLoading ? (
            <>
              <SkeletonBox className="w-64 h-14 rounded-2xl" />
              <SkeletonBox className="w-48 h-14 rounded-2xl" />
            </>
          ) : (
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4 mb-12">
              <Button
                size="lg"
                onClick={() => navigate("/auth")}
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-7 rounded-2xl text-lg font-bold"
              >
              ...
              <Button
                ...
                className="w-full sm:w-auto border-purple-500/30 bg-purple-500/5 px-8 py-7 rounded-2xl text-lg font-bold"
              >
            ...
            <div className="bg-[#0A1A2F] rounded-[23px] overflow-hidden p-6 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-10">
              <div className="text-center lg:text-left flex-1">
                ...
                <p className="text-white/60 mb-8 max-w-md">
                  Get full access to AI-powered PC automation.{" "}
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button
                    size="lg"
                    className="bg-orange-500 hover:bg-orange-400 font-bold"
                  >
                    <a href="/pricing">Claim 50% Discount</a>
                  </Button>
                  <Button
                    variant="outline"
                  ...
                  >
                    <a href="/pricing">Start ₹1 Trial</a>
                  </Button>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 w-full lg:w-auto">
                <p className="text-center text-white/40 text-xs uppercase mb-4 tracking-widest">
                  Offer Ends In
                </p>
                <div className="flex items-center justify-center gap-2 md:gap-3">
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center">
                      <div className="bg-gradient-to-br from-orange-500 to-red-600 w-12 h-12 md:w-16 md:h-16 rounded-xl flex items-center justify-center font-black text-xl md:text-2xl shadow-lg">
                        {String(t.v).padStart(2, "0")}
                      </div>
                      <span className="text-[8px] md:text-[10px] mt-2 text-white/50 font-bold uppercase">
                        {t.l}
                      </span>
                    </div>
                  ))}
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-white/40 max-w-xl mx-auto text-sm md:text-base">
              Experience the seamless integration of ALSA AI with your desktop
              environment.
            </p>
          </div>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, i) => (
              <Card
                key={i}
                className={`bg-white/5 border-white/5 relative ${plan.highlight ? "ring-2 ring-blue-500 md:scale-105" : ""}`}
              >
                <CardHeader>
      ...
      <footer className="py-16 px-6 border-t border-white/5 bg-slate-950/80">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-white/40 text-sm leading-relaxed">
                AI Lifestyle & Smart Assistant - Your intelligent companion for
                PC automation and productivity.
              </p>
            </div>
            <div>
          ...
          <div className="mt-16 pt-8 border-t border-white/5 text-center text-white/40 text-sm">
            <p>
              © 2024 ALSA AI. All rights reserved. Created with ❤️ by Mohd Eisa.
            </p>
          </div>
        </div>
      </footer>
